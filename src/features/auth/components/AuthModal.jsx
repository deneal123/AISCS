...
import { DRAWER_OVERLAY_PROPS } from '@theme/drawer';
import { FiLock, FiCalendar, FiMessageSquare } from '@shared/icons';
...
function AuthModal({ isOpen, onClose, title, description, onAuth, type = 'general' }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered size="md">
      <ModalOverlay {...DRAWER_OVERLAY_PROPS} />
      <ModalContent
        bg={colors.bg.menu}
      ...
      >
        ...
        <ModalCloseButton aria-label="Закрыть окно входа" color={colors.text.secondary} />
          ...
          <VStack spacing={5} align="center">
            ...
            <VStack spacing={3} w="full" maxW="300px">
              ...
              <Button
                ...
                fontWeight="600"
                borderRadius="xl"
                _hover={{ bg: colors.border.subtle, borderColor: 'rgba(255,255,255,0.34)' }}
