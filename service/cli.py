...
def parser() -> argparse.ArgumentParser:
    ...
    new.add_argument("document_id")
    new.add_argument("slug")
    new.add_argument("title")
    new.add_argument("--kind", choices=("conference", "paper"), required=True)
    new.add_argument("--language", choices=("ru", "en"), default="ru")
...
def main() -> None:
    ...
    try:
        if args.command == "status":
            ...
            payload = sidecar.new_publication(
                args.document_id,
                args.slug,
                args.title,
                args.kind,
