...
class FakeSaver:
    ...
    async def fetch_file_metadata(self, user_id, file_id):
        ...
        return FileMetadataLogic(
            ...
            file_key="folder/TRAINING/test.jpg",
        )
...
def test_presign_and_callback():
    ...
    try:
        ...
        resp4 = client.get(
            "/api/service/files/v1/00000000-0000-0000-0000-000000000000/download",
            follow_redirects=False,
        )
        assert resp4.status_code == 307
        assert resp4.headers["location"].startswith("https://download.local/")
    finally:
