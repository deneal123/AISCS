...
Навигатор рабочих документов находится в `documents/README.md`; каждая редактируемая
публикация создаётся как переносимая папка `documents/<PUB-ID>/` с собственным `main.tex`.
...
uv run --frozen pubctl new PUB-002 article-slug "Рабочее название" --kind paper --apply
